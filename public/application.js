...
/***/ (function(module, exports, __webpack_require__) {
	...
	var locationEvents = __webpack_require__(40
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://eliottenos.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var renderView = function renderView(element, hbsFile, params) {
	  var template = __webpack_require__(8)("./" + hbsFile + '.handlebars');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		"./form-auth.handlebars": 9,
		"./form-change-password.handlebars": 29,
		"./get-locations.handlebars": 30,
		"./locations.handlebars": 31,
		"./nav-private.handlebars": 32,
		"./nav-public.handlebars": 33,
		"./show-map.handlebars": 34
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<h3>\n  Location:\n</h3>\n<h4>\n "
	    ...
	    + "\" type=\"button\" class=\"delete-location\">Delete Location</button>\n<p>Update Location Notes:</p>\n<form class='location-update' id='update-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h3>Create Location</h3>\n        <form class='locations' id='location-create'>\n        <div class=\"form-group\" class=\"form-reset\">\n          <input type=\"text\" name=\"place[country]\" id=\"location-create\" placeholder=\"Location\">\n            <input type=\"text\" name=\"place[note]\" id=\"location-create\" placeholder=\"Note\">\n        <input type=\"submit\" name=\"submit\" value=\"Submit\">\n      </form>\n      <div class=\"createSuccess\"> </div>\n      <div class=\"createBlank\"> </div>\n\n      <button id='location-get' type=\"button\" class=\"btn btn-secondary btn-lg btn-block\">Get Locations</button>\n\n<div class=\"getBlank1\"> </div>\n\n<div class=\"getBlank2\"> </div>\n\n      <!-- <h3>Update Location Notes</h3>\n      <form class='locations' id='location-update'>\n       <div class=\"form-group\">\n         <input type=\"text\" name=\"place[country]\" id=\"location-update\"placeholder=\"Location\">\n         <input type=\"text\" name=\"place[note]\" id=\"location-update\"placeholder=\"Note\">\n       <input type=\"submit\" name=\"submit\" value=\"Submit\">\n     </form> -->\n     <div class=\"updateBlank\"> </div>\n     <div class=\"updateBlank1\"> </div>\n\n      <!-- <h3>Delete Location</h3>\n        <form class='locations' id='location-delete'>\n        <div class=\"form-group\">\n          <input type=\"text\" name=\"location[country]\" id=\"location-country-delete\" placeholder=\"Location\">\n        <input type=\"submit\" name=\"submit\" value=\"Submit\">\n        <div class=\"deleteLocation\"> </div> -->\n      <!-- </form> -->\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var authUi = __webpack_require__(39
	// api and ui methods for authentication
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetAllLocations = function onGetAllLocations() {
	  api.getLocation('').then(ui.getLocationSuccess).catch(ui.getLocationError
	  // } else {
	...
	var onUpdateLocation = function onUpdateLocation(event) {
	  ...
	  var updateLocation = event.target.id.slice(index + 1);
	  console.log('id here', updateLocation);
	  api.updateLocation(updateLocation, data).then(ui.updateLocationSuccess).catch(ui.updateLocationFailure
	  // } else {
	  //   console.log('Please provide a location id!')
	  );
	};
	...
	var onDeleteLocation = function onDeleteLocation(event) {
	  ...
	  // const place = event.target
	  var index = event.target.id.indexOf('-');
	  var deleteLocation = event.target.id.slice(index + 1);
	  console.log('id here', deleteLocation);
	  api.deleteLocation(deleteLocation).then(ui.deleteLocationSuccess).catch(ui.deleteLocationFailure
	  // } else {
	  //   console.log('Please provide a location id!')
	  );
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(38);
	var showLocationTemplate = __webpack_require__(30);
	...
	var getLocationSuccess = function getLocationSuccess(data) {
	  ...
	  // console.log($(data))
	  ();var locations = showLocationTemplate({ locations: data.places });
